...
public class FieldGUI {
        ...
        public static Field[] fields = {
                ...
                new Shipping("Øresund", 4000, "4000 Kr Leje:  500" , Color.BLACK, Color.blue),
                ...
                new Shipping("D.F.D.S.", 4000, "4000 Kr Leje:  500", Color.BLACK, Color.RED),
                ...
                new Shipping("Ø.S. redderiet", 4000, "4000 Kr Leje:  500", Color.BLACK, Color.blue),
                new Street("Bredgade", 5200, "5200 kr", Color.BLACK, Color.white),
                new Street("Kgs. Nytorv", 5200, "5200 kr", Color.BLACK, Color.white),
                new Brewery("Carlsberg", 3000, "Carlsberg bryggeri: 3000 kr", Color.BLACK, Color.red),
                ...
                new Shipping("Bornholms redderi", 4000, "4000 Kr Leje:  500", Color.BLACK, Color.BLUE),
                new Chance("Chancekort", Color.WHITE, Color.BLACK),
